...
use App\Imagenestamanho;

class ImagenestamanhoController extends Controller
{
    ...
    {
        try {
            $queryresult = Imagenestamanho::get();
    ...
    {
        try {
            $queryresult = Imagenestamanho::where('id', $id)
                ->get();
            return response()->json(['respuesta' => true, 'resultado' => $queryresult]);
        } catch (QueryException $e) {
            return response()->json(['respuesta' => false, 'resultado' => $e->errorInfo]);
    ...
    {
        try {
            $queryresult = Imagenestamanho::create(
                [
                    'imagenes_id' => $request['imagenes_id'],
                    'tamanhos_id' => $request['tamanhos_id'],
                    'preciobs' => $request['preciobs'],
                    'preciosus' => $request['preciosus'],
    ...
    {
        return Imagenestamanho::campos();
    }

    public function estructura()
    {
        $tabla = Imagenestamanho::tabla();
        $campos = Imagenestamanho::campos();
        $resultado = array();
